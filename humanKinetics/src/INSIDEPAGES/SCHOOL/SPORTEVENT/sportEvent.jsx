    ...
    <>
      ...
      <div className="ml-64 mt-16 flex flex-col min-h-screen bg-gray-100">
        ...
        <main className="flex-grow p-6">
          <h1 className="text-2xl font-bold text-green-700 mb-6">Sports Events</h1>
          ...
          <div className="space-y-6">
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="flex items-center space-x-2 mb-2">
                    <h2 className="text-xl font-bold text-gray-800">PLSP vs. State University</h2>
                    <span className="px-2 py-1 text-xs font-bold rounded-full bg-gray-200 text-gray-700">varsity</span>
                  </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-blue-500">
              <div className="flex items-center space-x-2 mb-2">
                <h2 className="text-xl font-bold text-gray-800">Regional Tournament</h2>
                <span className="px-2 py-1 text-xs font-bold rounded-full bg-blue-100 text-blue-700">women</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border-l-4 border-green-500">
              <div className="flex items-center space-x-2 mb-2">
                <h2 className="text-xl font-bold text-gray-800">Inter-College League</h2>
                <span className="px-2 py-1 text-xs font-bold rounded-full bg-green-100 text-green-700">men</span>
              </div>
