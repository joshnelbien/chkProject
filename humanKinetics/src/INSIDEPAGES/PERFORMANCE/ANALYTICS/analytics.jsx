      ...
      >
        ...
        <main className="flex-1 overflow-y-auto mt-16 p-4 md:p-6">
          ...
          <div className="flex flex-wrap items-center gap-2 mb-6">
            {["Overview", "Performance", "Attendance"].map((filter, idx) => (
              <button
                key={idx}
          ...
          {/* Top Performing & Improvement Areas */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <ul className="space-y-3">
                {[
                  { area: "Shooting Accuracy", value: "92%" },
                  { area: "Team Coordination", value: "88%" },
                  { area: "Physical Fitness", value: "85%" },
                ].map((item, idx) => (
                  <li
                    key={idx}
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <ul className="space-y-3">
                {[
                  { area: "Defense Tactics", value: "72%" },
                  { area: "Endurance", value: "68%" },
                  { area: "Game Strategy", value: "65%" },
                ].map((item, idx) => (
                  <li
                    key={idx}
                    className="flex justify-between items-center text-gray-700"
